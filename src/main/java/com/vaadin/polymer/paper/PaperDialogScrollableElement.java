...
public class PaperDialogScrollableElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  JavaScriptObject getDialogElement();
    /**
     * <p>The dialog element that implements <code>Polymer.PaperDialogBehavior</code> containing this element.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setDialogElement(JavaScriptObject value);
     ...
     * 
     */
    public native void updateScrollState();
