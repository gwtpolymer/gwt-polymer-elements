...
public class PaperCardElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  boolean getAnimatedShadow();
    /**
     * <p>Set this to true to animate the card shadow when setting a new<br><code>z</code> value.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setAnimatedShadow(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getFadeImage();
    /**
     * <p>When <code>preloadImage</code> is true, setting <code>fadeImage</code> to true will cause the<br>image to fade into place.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setFadeImage(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getPreloadImage();
    /**
     * <p>When <code>true</code>, any change to the image url property will cause the<br><code>placeholder</code> image to be shown until the image is fully rendered.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setPreloadImage(boolean value);
     ...
     * 
     */
    @JsProperty public native  String getHeading();
    /**
     * <p>The title of the card.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setHeading(String value);
     ...
     * 
     */
    @JsProperty public native  String getImage();
    /**
     * <p>The url of the title image of the card.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setImage(String value);
     ...
     * 
     */
    @JsProperty public native  String getPlaceholderImage();
    /**
     * <p>This image will be used as a background/placeholder until the src image has<br>loaded. Use of a data-URI for placeholder is encouraged for instant rendering.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setPlaceholderImage(String value);
