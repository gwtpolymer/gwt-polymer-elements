...
public class PaperToastElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  void setDuration(double value);
     ...
     * 
     */
    @JsProperty public native  String getText();
    /**
     * <p>The text to display in the toast.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setText(String value);
     ...
     * 
     */
    public native void show(Object properties);
