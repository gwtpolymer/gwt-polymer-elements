...
public class PaperTabsElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  double getAutoselectDelay();
    /**
     * <p>The delay (in milliseconds) between when the user stops interacting<br>with the tabs through the keyboard and when the focused item is<br>automatically selected (if <code>autoselect</code> is true).</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setAutoselectDelay(double value);
     ...
     * 
     */
    @JsProperty public native  boolean getAlignBottom();
    /**
     * <p>If true, the tabs are aligned to bottom (the selection bar appears at the top).</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setAlignBottom(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getAutoselect();
    /**
     * <p>If true, tabs are automatically selected when focused using the<br>keyboard.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setAutoselect(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getNoBar();
    /**
     * <p>If true, the bottom bar to indicate the selected tab will not be shown.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setNoBar(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getNoSlide();
    /**
     * <p>If true, the slide effect for the bottom bar is disabled.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setNoSlide(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getScrollable();
    /**
     * <p>If true, tabs are scrollable and the tab width is based on the label width.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setScrollable(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getDisableDrag();
    /**
     * <p>If true, dragging on the tabs to scroll is disabled.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setDisableDrag(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getFitContainer();
    /**
     * <p>If true, tabs expand to fit their container. This currently only applies when<br>scrollable is true.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setFitContainer(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getHideScrollButtons();
    /**
     * <p>If true, scroll buttons (left/right arrow) will be hidden for scrollable tabs.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setHideScrollButtons(boolean value);
