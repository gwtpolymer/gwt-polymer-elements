...
public class PaperDropdownMenuLightElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  boolean getHasContent();
    /**
     * 
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setHasContent(boolean value);
     ...
     * 
     */
    @JsProperty public native  String getSelectedItemLabel();
    /**
     * <p>The derived “label” of the currently selected item. This value<br>is the <code>label</code> property on the selected item if set, or else the<br>trimmed text content of the selected item.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setSelectedItemLabel(String value);
