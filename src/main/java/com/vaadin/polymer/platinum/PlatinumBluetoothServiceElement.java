...
public class PlatinumBluetoothServiceElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  String getService();
    /**
     * <p>Required Bluetooth GATT primary service. You may provide either the<br>full Bluetooth UUID as a string or a short 16- or 32-bit form as<br>integers like 0x180d.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setService(String value);
