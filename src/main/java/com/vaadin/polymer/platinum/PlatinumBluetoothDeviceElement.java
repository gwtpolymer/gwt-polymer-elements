...
public class PlatinumBluetoothDeviceElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  JavaScriptObject getDevice();
    /**
     * <p>Current Bluetooth device picked by user.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setDevice(JavaScriptObject value);
     ...
     * 
     */
    @JsProperty public native <E> Array<E> getOptionalServicesFilter();
    /**
     * <p>Optional Bluetooth GATT services filter. This implies that if you<br>filter just by name, you must use <code>optionalServicesFilter</code> to get<br>access to any services. You may provide either the full Bluetooth<br>UUID as a string or a short 16- or 32-bit form as integers like<br>0x180d.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native <E> void setOptionalServicesFilter(Array<E> value);
     ...
     * 
     */
    @JsProperty public native <E> Array<E> getServicesFilter();
    /**
     * <p>Bluetooth GATT services filter. You may provide either the<br>full Bluetooth UUID as a string or a short 16- or 32-bit form as<br>integers like 0x180d.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native <E> void setServicesFilter(Array<E> value);
     ...
     * 
     */
    @JsProperty public native  String getNameFilter();
    /**
     * <p>Device name filter.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setNameFilter(String value);
     ...
     * 
     */
    @JsProperty public native  String getNamePrefixFilter();
    /**
     * <p>Device name prefix filter.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setNamePrefixFilter(String value);
     ...
     */
    public native JavaScriptObject request();
