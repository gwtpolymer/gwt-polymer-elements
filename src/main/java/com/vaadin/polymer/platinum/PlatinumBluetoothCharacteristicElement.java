...
public class PlatinumBluetoothCharacteristicElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  boolean getAutoWrite();
    /**
     * <p>If true, automatically perform a write <code>value</code> on the characteristic<br>when <code>value</code> changes.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setAutoWrite(boolean value);
     ...
     * 
     */
    @JsProperty public native  String getCharacteristic();
    /**
     * <p>Required Bluetooth GATT characteristic for read and write operations.<br>You may provide either the full Bluetooth UUID as a string or a<br>short 16- or 32-bit form as integers like 0x2A19.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setCharacteristic(String value);
     ...
     */
    public native JavaScriptObject write(Object value);
     ...
     * @return {JavaScriptObject}
     */
    public native JavaScriptObject startNotifications();
     ...
     * @return {JavaScriptObject}
     */
    public native JavaScriptObject stopNotifications();
