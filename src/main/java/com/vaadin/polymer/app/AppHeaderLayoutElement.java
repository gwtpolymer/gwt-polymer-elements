...
public class AppHeaderLayoutElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  boolean getHasScrollingRegion();
    /**
     * <p>If true, the current element will have its own scrolling region.<br>Otherwise, it will use the document scroll to control the header.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setHasScrollingRegion(boolean value);
