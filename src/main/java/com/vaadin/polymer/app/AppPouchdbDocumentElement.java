...
public class AppPouchdbDocumentElement extends PolymerElement {
     ...
     */
    @JsProperty public native  JavaScriptObject getZeroValue();
    /**
     * <p>Override this getter to define the default value to use when<br>there’s no data stored.</p>
     *
     * JavaScript Info:
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  void setZeroValue(JavaScriptObject value);
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  JavaScriptObject getData();
    /**
     * <p>The data to synchronize.</p>
     *
     * JavaScript Info:
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  void setData(JavaScriptObject value);
     ...
     * 
     */
    @JsProperty public native  JavaScriptObject getChanges();
    /**
     * <p>A changes event emitter. Notifies of changes to the PouchDB document<br>referred to by <code>docId</code>, if a <code>docId</code> has been provided.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setChanges(JavaScriptObject value);
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  boolean getIsNew();
    /**
     * <p>Override this getter to return true if the value has never been<br>persisted to storage.</p>
     *
     * JavaScript Info:
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  void setIsNew(boolean value);
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  boolean getSequentialTransactions();
    /**
     * <p>If this is true transactions will happen one after the other,<br>never in parallel.</p>
     * <p>Specifically, no transaction will begin until every previously<br>enqueued transaction by this element has completed.</p>
     * <p>If it is false, new transactions will be executed as they are<br>received.</p>
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  void setSequentialTransactions(boolean value);
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  JavaScriptObject getTransactionsComplete();
    /**
     * <p>A promise that will resolve once all queued transactions<br>have completed.</p>
     * <p>This field is updated as new transactions are enqueued, so it will<br>only wait for transactions which were enqueued when the field<br>was accessed.</p>
     * <p>This promise never rejects.</p>
     ...
     * @behavior AppPouchdbDocument
     */
    @JsProperty public native  void setTransactionsComplete(JavaScriptObject value);
     ...
     * 
     */
    @JsProperty public native  String getRev();
    /**
     * <p>The current _rev (revision) of the PouchDB document that this<br>element’s data refers to, if the document is not new.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setRev(String value);
     ...
     * 
     */
    @JsProperty public native  String getDocId();
    /**
     * <p>The value of the _id (Pouch/Couch unique identifier) of the PouchDB<br>document that this element’s data should refer to.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setDocId(String value);
     ...
     * 
     */
    public native void setStoredValue(Object storagePath, Object value);
     ...
     * 
     */
    public native void getStoredValue(Object storagePath);
     ...
     * 
     */
    public native void valueIsEmpty(Object value);
     ...
     */
    public native JavaScriptObject initializeStoredValue();
     ...
     * @return {JavaScriptObject}
     */
    public native JavaScriptObject destroy();
     ...
     * @return {JavaScriptObject}
     */
    public native JavaScriptObject saveValue(JavaScriptObject args);
     ...
     * @return {JavaScriptObject}
     */
    public native JavaScriptObject setStoredValue(String storagePath, JavaScriptObject value);
     ...
     * @return {String}
     */
    public native String storagePathToMemoryPath(String path);
     ...
     * @return {String}
     */
    public native String memoryPathToStoragePath(String path);
     ...
     * 
     */
    public native void syncToMemory(PolymerFunction operation);
