...
public class AppRouteElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  JavaScriptObject getTail();
    /**
     * <p>The part of <code>route.path</code> NOT consumed by <code>pattern</code>.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setTail(JavaScriptObject value);
