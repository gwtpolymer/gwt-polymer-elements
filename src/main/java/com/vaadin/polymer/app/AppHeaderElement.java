...
public class AppHeaderElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  boolean getCondenses();
    /**
     * <p>If true, the header will automatically collapse when scrolling down.<br>That is, the <code>sticky</code> element remains visible when the header is fully condensed<br>whereas the rest of the elements will collapse below <code>sticky</code> element.</p>
     * <p>By default, the <code>sticky</code> element is the first toolbar in the light DOM:</p>
     * <pre><code class="lang-html">&lt;app-header condenses&gt;
     ...
     * 
     */
    @JsProperty public native  void setCondenses(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getReveals();
    /**
     * <p>Slides back the header when scrolling back up.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setReveals(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getShadow();
    /**
     * <p>Displays a shadow below the header.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setShadow(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getFixed();
    /**
     * <p>Mantains the header fixed at the top so it never moves away.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setFixed(boolean value);
     ...
     * @behavior AppBox
     */
    @JsProperty public native  double getThreshold();
    /**
     * <p>Allows to set a <code>scrollTop</code> threshold. When greater than 0, <code>thresholdTriggered</code><br>is true only when the scroll target’s <code>scrollTop</code> has reached this value.</p>
     * <p>For example, if <code>threshold = 100</code>, <code>thresholdTriggered</code> is true when the <code>scrollTop</code><br>is at least <code>100</code>.</p>
     *
     ...
     * @behavior AppBox
     */
    @JsProperty public native  void setThreshold(double value);
     ...
     * @behavior AppBox
     */
    @JsProperty public native  boolean getThresholdTriggered();
    /**
     * <p>True if the <code>scrollTop</code> threshold (set in <code>scrollTopThreshold</code>) has<br>been reached.</p>
     *
     * JavaScript Info:
     ...
     * @behavior AppBox
     */
    @JsProperty public native  void setThresholdTriggered(boolean value);
     ...
     * @behavior AppBox
     */
    @JsProperty public native  JavaScriptObject getEffectsConfig();
    /**
     * <p>An object that configurates the effects installed via the <code>effects</code> property. e.g.</p>
     * <pre><code class="lang-js"> element.effectsConfig = {
     *   &quot;blend-background&quot;: {
     ...
     * @behavior AppBox
     */
    @JsProperty public native  void setEffectsConfig(JavaScriptObject value);
     ...
     * @behavior AppBox
     */
    @JsProperty public native  String getEffects();
    /**
     * <p>A space-separated list of the effects names that will be triggered when the user scrolls.<br>e.g. <code>waterfall parallax-background</code> installs the <code>waterfall</code> and <code>parallax-background</code>.</p>
     *
     * JavaScript Info:
     ...
     * @behavior AppBox
     */
    @JsProperty public native  void setEffects(String value);
     ...
     * @return {boolean}
     */
    public native boolean isContentBelow();
     ...
     * @return {boolean}
     */
    public native boolean isOnScreen();
     ...
     */
    public native JavaScriptObject getScrollState();
     ...
     * @return {boolean}
     */
    public native boolean willCondense();
     ...
     * @return {JavaScriptObject}
     */
    public native JavaScriptObject createEffect(String effectName, JavaScriptObject effectConfig);
