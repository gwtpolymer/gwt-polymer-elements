...
public class IronScrollThresholdElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  double getLowerThreshold();
    /**
     * <p>Distance from the bottom (or right, for horizontal) bound of the scroller<br>where the “lower trigger” will fire.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setLowerThreshold(double value);
     ...
     * 
     */
    @JsProperty public native  double getUpperThreshold();
    /**
     * <p>Distance from the top (or left, for horizontal) bound of the scroller<br>where the “upper trigger” will fire.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setUpperThreshold(double value);
     ...
     * 
     */
    @JsProperty public native  boolean getUpperTriggered();
    /**
     * <p>Read-only value that tracks the triggered state of the upper threshold.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setUpperTriggered(boolean value);
     ...
     * 
     */
    @JsProperty public native  boolean getLowerTriggered();
    /**
     * <p>Read-only value that tracks the triggered state of the lower threshold.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setLowerTriggered(boolean value);
     ...
     * 
     */
    public native void checkScrollThesholds();
     ...
     * 
     */
    public native void checkScrollThresholds();
     ...
     * 
     */
    public native void clearTriggers();
