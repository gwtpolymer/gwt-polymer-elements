...
public class IronInputElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  String getBindValue();
    /**
     * <p>Use this property instead of <code>value</code> for two-way data binding.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setBindValue(String value);
