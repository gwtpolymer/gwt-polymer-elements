...
public class IronDeselectEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "iron-deselect";

    public IronDeselectEvent(EventInit eventInitDict) {
