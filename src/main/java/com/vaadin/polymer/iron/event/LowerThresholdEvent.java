...
public class LowerThresholdEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "lower-threshold";

    public LowerThresholdEvent(EventInit eventInitDict) {
