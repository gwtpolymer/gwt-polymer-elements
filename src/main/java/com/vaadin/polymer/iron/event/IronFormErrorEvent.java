...
public class IronFormErrorEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "iron-form-error";

    public IronFormErrorEvent(EventInit eventInitDict) {
