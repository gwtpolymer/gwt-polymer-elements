...
public class IronA11yKeysElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  JavaScriptObject getTarget();
    /**
     * 
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setTarget(JavaScriptObject value);
     ...
     * 
     */
    @JsProperty public native  String getKeys();
    /**
     * <p>Space delimited list of keys where each key follows the format:<br><code>[MODIFIER+]*KEY[:EVENT]</code>.<br>e.g. <code>keys=&quot;space ctrl+shift+tab enter:keyup&quot;</code>.<br>More detail can be found in the “Grammar” section of the documentation</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setKeys(String value);
