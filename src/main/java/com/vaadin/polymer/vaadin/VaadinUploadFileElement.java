...
public class VaadinUploadFileElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  JavaScriptObject getFile();
    /**
     * <p>File metadata, upload status and progress information.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setFile(JavaScriptObject value);
