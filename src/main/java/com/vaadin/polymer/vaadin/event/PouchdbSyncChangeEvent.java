...
public class PouchdbSyncChangeEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "pouchdb-sync-change";

    public PouchdbSyncChangeEvent(EventInit eventInitDict) {
