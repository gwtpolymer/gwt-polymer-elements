...
public class PouchdbSyncPausedEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "pouchdb-sync-paused";

    public PouchdbSyncPausedEvent(EventInit eventInitDict) {
