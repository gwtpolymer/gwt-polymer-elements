...
public class UploadStartEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "upload-start";

    public UploadStartEvent(EventInit eventInitDict) {
