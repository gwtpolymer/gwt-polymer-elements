...
public class UploadRetryEvent extends PolymerEvent {

    @JsOverlay public static final String NAME = "upload-retry";

    public UploadRetryEvent(EventInit eventInitDict) {
