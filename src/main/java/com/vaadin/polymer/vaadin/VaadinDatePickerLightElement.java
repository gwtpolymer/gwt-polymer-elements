...
public class VaadinDatePickerLightElement extends PolymerElement {
     ...
     * @behavior VaadinDatePicker
     */
    @JsProperty public native  String getInitialPosition();
    /**
     * <p>Date which should be visible when there is no value selected.</p>
     * <p>The same date formats as for the <code>value</code> property are supported.</p>
     *
     ...
     * @behavior VaadinDatePicker
     */
    @JsProperty public native  void setInitialPosition(String value);
