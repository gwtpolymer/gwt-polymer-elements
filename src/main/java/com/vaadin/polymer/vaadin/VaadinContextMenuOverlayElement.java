...
public class VaadinContextMenuOverlayElement extends PolymerElement {
     ...
     * 
     */
    @JsProperty public native  double getY();
    /**
     * <p>Position of the overlay on vertical axis.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setY(double value);
     ...
     * 
     */
    @JsProperty public native  double getX();
    /**
     * <p>Position of the overlay on horizontal axis.</p>
     *
     * JavaScript Info:
     ...
     * 
     */
    @JsProperty public native  void setX(double value);
