...
public class VaadinGrid extends PolymerWidget {
     ...
     * 
     */
    public  PolymerFunction getRowClassGenerator() {
     ...
     * 
     */
    public  void setRowClassGenerator(PolymerFunction value) {
     ...
     * 
     */
    public <E> void setColumns(Array<E> value) {
     ...
     * 
     */
    public <E> Array<E> getDetailedEvents() {
     ...
     * 
     */
    public <E> void setDetailedEvents(Array<E> value) {
     ...
     * 
     */
    public <E> void setSortOrder(Array<E> value) {
     ...
     * 
     */
    public  PolymerFunction getCellClassGenerator() {
     ...
     * 
     */
    public  void setCellClassGenerator(PolymerFunction value) {
     ...
     * 
     */
    public  PolymerFunction getRowDetailsGenerator() {
     ...
     * 
     */
    public  void setRowDetailsGenerator(PolymerFunction value) {
     ...
     */
    public JavaScriptObject then(PolymerFunction callback) {
     ...
     * 
     */
    public void getItem(double rowIndex, PolymerFunction callback, boolean onlyCached) {
